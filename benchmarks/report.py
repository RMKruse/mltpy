...
def _interpret(
    ...
    parts = [
        ...
        "holds.  pymlt is now the faster backend in every cell, and the size "
        ...
        "overhead that previously let R lead the n=100–1000 cells, so pymlt "
        ...
        "pymlt evaluates once per fit and caches (it depends only on `y` and "
